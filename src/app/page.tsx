                  ...
                  >
                    <div className="grid lg:grid-cols-12 gap-4 sm:gap-8">
                      <div className="lg:col-span-2">
                        <div className="text-xl sm:text-2xl font-bold flex items-center justify-center h-full transition-all duration-500 group-hover:text-foreground group-hover:scale-110">
                          {job.year}
                        </div>
                      </div>
                      ...
                      <div className="lg:col-span-4 flex flex-wrap gap-2 lg:justify-end mt-2 lg:mt-0">
                        {job.tech.map((tech) => (
                          <span
                            key={tech}
                            className="px-2 py-1 text-xs border border-border transition-colors duration-300 group-hover:bg-foreground group-hover:text-background"
                          >
                            {tech}
                          </span>
                        ))}
